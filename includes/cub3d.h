...
typedef struct s_player
{
	...
	float y;
	float raduis;
	float turn_direction; //-1 for left +1 for right or left (help me with changing the position of the player )
	float walk_direction; //-1 for back +1 for front or back
	float rotation_angle; // angle in radian
	float walk_speed;	  // the speed of the player
	float turn_speed;	  // the turn speed of the player
	float look;
	int step;
} t_player;
